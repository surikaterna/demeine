...
Repository.prototype.findBySnapshot = function (id, isRetry, callback) {
  ...
  return self._partition
    ...
    .then(function (snapshot) {
      return self._partition.queryStream(id, (snapshot && snapshot.version) || 0).then(async function (commits) {
        var events = [];
        ...
        try {
          await aggregate._rehydrate(events, version, snapshot && snapshot.snapshot);
        } catch (e) {
